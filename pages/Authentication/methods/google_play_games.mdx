...
10. You should an similar output, you need to copy the `SHA1` value and store it somewhere safe as we will need it while creating an `OAuth Client` in Step 2.
...
<Image src={PGSImage} alt="Go to Grow Users -> PGS -> Configuration button" height={600} />
