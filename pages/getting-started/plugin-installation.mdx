...
<Callout type="warning">
    Unfortunately, the Epic Games FAB plugin disrupts the functionality of the EIK plugins. The FAB plugin enables the EOS Shared Engine plugin, while EIK utilizes a custom version, leading to conflicts between the two. This can result in a LNK2005 error during project packaging or prevent EIK from initializing properly.
